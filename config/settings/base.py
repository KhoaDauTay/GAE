...
MESSAGE_TAGS = {
    message_constants.DEBUG: "pink",
    message_constants.INFO: "lightBlue",
    message_constants.SUCCESS: "emerald",
    message_constants.WARNING: "amber",
...
MIDDLEWARE = [
    ...
    "erp_greenwich.auth.casbin.jwt_authentication.JwtAuthenticationMiddleware",
    "erp_greenwich.auth.casbin.count_request.CountMiddleware",
]
